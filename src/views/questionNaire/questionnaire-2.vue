		...
		<el-table :data="naires" highlight-current-row v-loading="listLoading" style="width: 100%;" :border="true">
			...
			<el-table-column label="操作" width="240" fixed="right" align="center">
				<template scope="scope">
					<el-button type="danger" size="small" @click="handleStatus(scope.$index, scope.row)">问卷截至</el-button>
				</template>
			</el-table-column>
		</el-table>
...
<script>
	...
	import { getNaireListPage, changeStatus } from '../../api/api';
